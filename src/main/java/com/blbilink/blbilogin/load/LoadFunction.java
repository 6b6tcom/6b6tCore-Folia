...
import com.blbilink.blbilogin.modules.events.AntiOpListener;
...
public class LoadFunction {
    ...
    private void loadCommands(){
        ...
        Objects.requireNonNull(plugin.getCommand("stats")).setExecutor(new WorldStatsCommand());
    ...
    private void loadListeners(){
        ...
        Bukkit.getPluginManager().registerEvents(new AntiOpListener(), plugin);
